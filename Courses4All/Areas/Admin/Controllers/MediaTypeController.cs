...
namespace Courses4All.Areas.Admin.Controllers
{
    ...
    public class MediaTypeController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Title,CoverImage")] MediaType mediaType)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Title,CoverImage")] MediaType mediaType)
        {
            if (id != mediaType.Id)
            {
                return NotFound();
